    ...
    miningOnAction(0)
{
    ...
    QString windowTitle = tr("SUQA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About SUQA Core"), this);
    aboutAction->setStatusTip(tr("Show information about SUQA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SUQA Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SUQA addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SUQA addresses"));
    ...
    openAction->setStatusTip(tr("Open a suqa: URI or payment request"));

    showHelpMessageAction = new QAction(TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SUQA Core help message to get a list with possible SUQA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SUQA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SUQA network", "", count));
}
...
{
    QString strTitle = tr("SUQA"); // default title
