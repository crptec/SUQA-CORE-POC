...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->resize(850, 622);
        SendCoinsDialog->setStyleSheet(QLatin1String("\n"
"QStatusBar {\n"
...
""));
        ...
        labelCoinControlChangeLabel->setMargin(-6);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 832, 95));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/tx_output"), QSize(), QIcon::Normal, QIcon::Off);
