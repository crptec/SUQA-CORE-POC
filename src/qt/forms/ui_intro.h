...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        Intro->setStyleSheet(QLatin1String("\n"
"QStatusBar {\n"
...
""));
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to SUQA Core.", 0));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where SUQA Core will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "SUQA Core will download and store a copy of the Bitcoin block chain. At least %1MB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0));
